...
export default function ColorCard({ hex }: Props) {
  ...
  return (
    <div
      onClick={handleClick}
      className="flex flex-col border justify-between rounded-lg shadow-lg w-20 h-28 sm:w-28 sm:h-32 md:w-28 md:h-32 lg:w-40 lg:h-48  cursor-pointer hover:outline hover:outline-black/80"
    >
      <div
